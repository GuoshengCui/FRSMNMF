function options = set_paras_dc_mvnmf_l2(dataset,options)
n_view = options.n_view;
X_label = options.X_label;
X_unlabel = options.X_unlabel;

options = choose_nn_dc_mvnmf_l2(dataset,options);
...
function [options] = choose_nn_dc_mvnmf_l2(dataset,options)
